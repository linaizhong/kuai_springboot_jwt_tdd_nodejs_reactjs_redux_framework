  ...
  return createElement('span', {
    ...
    children: chunks.map((chunk, index) => {
      ...
      if (chunk.highlight) {
        ...
        return <a style={{color: '#0000ff'}} onClick={event => handleclick(event, text)}>{text}</a>
//        return (<Tooltip open={open} onClose={handleClose} onOpen={event => handleclick(event, link)} title={text}>
//                {text}
//            </Tooltip>)
      } else {
        return createElement('span', {
