...
export default class MusicK10SyllabusGraphViewer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      odata: data,
        ...
        <div className="graph-pane">
          <div id="control" style={{backgroundColor: '#555', textAlign: 'right'}}>
            <span>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <Link to="#" onClick={event => this.handleZoomClick(event, 1)}><span className="pe-7s-plus pe-2x pe-va" title="Zoom Out"></span></Link>
              &nbsp;&nbsp;
              <Link to="#" onClick={event => this.handleZoomClick(event, -1)}><span className="pe-7s-less pe-2x pe-va" title="Zoom In"></span></Link>
              &nbsp;&nbsp;
            </span>
          </div>
          <div id="sequence"></div>
