...
import data from "../datasets/nnlpv3.01.json";
import contents from "../datasets/nnlpv3.01.content.json";
...
export default class NumeracyLearningProgressionsGraphViewer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      odata: data,
    ...
    return (
      ...
      >
        ...
        <div className="details-pane" style={{backgroundColor: '#fff', height: '100%'}}>
          <Tabs defaultActiveKey="nlpContentView" id="uncontrolled-tab">
            <Tab eventKey="nlpContentView" title="Contents">
              ...
              <Tab eventKey="nlpMRView" title="Machine Readable">
                <div style={{paddingLeft: '6px', width: '100%', height: '800px', backgroundColor: '#fff'}}>
                  {this.state.nodedata !== null && 
                    <iframe src={this.state.nodedata.id} height='100%' width='100%' frameBorder="0"/>         
                  }
                  {this.state.nodedata === null && 
                    <iframe src='https://mrlp.australiancurriculum.edu.au/elements/learning-progressions/3.0/2020/09/d9df3bd1-d361-4f00-a813-c47865f63c4c' height='100%' width='100%' frameBorder="0"/>         
                  }
                </div>
              </Tab>
          </Tabs>
